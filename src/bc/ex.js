...
module.exports = app => {
   ...
   *     }
   */
  app.post('/api/v1/exs', sequelizeHandlers.create(ex));
   ...
   *     }
   */
  app.get('/api/v1/exs/:id', sequelizeHandlers.get(ex));


  app.get('/api/v1/exs', sequelizeHandlers.query(ex));
   ...
   *     }
   */
  app.delete('/api/v1/exs/:id', sequelizeHandlers.remove(ex));
   ...
   *     }
   */
  app.put('/api/v1/exs/:id', sequelizeHandlers.update(ex)); 
};
